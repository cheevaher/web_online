...
//           headers: {
//             'Authorization': `Bearer ${user.token}`,  // <-- ใช้ token จาก context
//           },
//         });
...
//         <h1 className="text-4xl font-bold mb-4 text-purple-800">คอร์สที่คุณซื้อแล้ว</h1>
//         <p className="text-lg text-purple-700 max-w-2xl mx-auto">
//           ดูและเรียนรู้คอร์สที่คุณได้ซื้อไว้
//         </p>
//       </section>
...
//           ))
//         ) : (
//           <p className="text-center col-span-full text-gray-500">คุณยังไม่ได้ซื้อคอร์สใด ๆ</p>
//         )}
//       </section>
//     </div>
//   );
